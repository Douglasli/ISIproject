<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_detail_vender_edit.aspx.cs" Inherits="_Default" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" Height="36px"  Text="Submit" Width="96px" OnClick="Button1_Click" />
        <br />
        <br />
        <asp:Label ID="Label3" runat="server" Font-Size="Larger" Text="Brand:  "></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" Height="24px" Width="154px"></asp:TextBox>
        <br />
        <br />
...
&nbsp;<br />
        <asp:Label ID="Label14" runat="server" Font-Size="Larger" Text="Change to nother thumbnail image:"></asp:Label>
        ...
        <asp:TextBox ID="TextBox4" runat="server" Height="24px" Width="242px"></asp:TextBox>
        <ul id="list1"></ul>
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:FileUpload ID="up2" runat="server" Height="26px" Width="272px" />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:FileUpload ID="up3" runat="server" Height="26px" Width="272px" />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:FileUpload ID="up4" runat="server" Height="26px" Width="272px" />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
